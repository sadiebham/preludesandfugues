...
is on one pramary subject.   For that subject the authors were asked to write
an introductory `prelude' setting out the main subject and key,
followed by a `fugue' or story or poem involving that, which might be
