...
of whatever length is an attribute that incorporates its entirety and overall structure.
...
fugue\=the word `fugue' literally meaning `flight' and by Bach's day
referred to a
...
E\fl\ major is often associated with the `heroic,' as used for example in
...
have historically chosen to write
music is a moot point, but there is no doubt that pieces of
...
fugues in literature. Each author has been asked to focus on
particular moods, emotions or traits and to write about a person,
object or place that conveys them.  Modulations (contrasting emotions)
were not discouraged and indeed Bach's 48~contain many modulations
too, but the focus is on one primary subject.  For that subject the
authors were asked to write an introductory `prelude' setting out the
main subject in its key, followed by a `fugue' or story or poem
involving it, which might be in a different literary style.
...
ways to think about what we write and in expanding and developing
literary style and technique in writing. We sincerely hope you will
enjoy reading them too.

\strut\hfill Sadie Kaye\break
